      ...
      <div style={styles.card}>
        {!isLoggedIn ? (
          <div style={styles.loginBox}>
            <h3>Login (Server-backed)</h3>
            <p>Use the demo credentials to authenticate against the API</p>
            <input
              type="email"
              placeholder="Email"
              value={email}
          ...
          <div>
            <div style={styles.loggedBox}>
              ...
              <p>
                <strong>Session token:</strong> {token}
              </p>
            ...
            <div style={styles.dashboard}>
              <p>
                📊 Welcome to your dashboard. Here is some statistics (demo).
              </p>
              <p>
                🔐 Your role: <strong>Trainer</strong>
              </p>
            </div>
            ...
            <div style={styles.adminLinkBox}>
              ...
              <p style={{ fontSize: "0.9rem", marginTop: "0.5rem" }}>
                💡 Try manually typing <code>/admin</code> in URL while logged
                out → redirects here.
              </p>
            </div>
          </div>
